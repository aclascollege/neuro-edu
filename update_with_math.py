...
# Updated body with mathematics section
...
Where $F_i(x)$ represents lexical complexity (Flesch-Kincaid), syntactic depth, and conceptual density (prerequisite counts).
...
By adding $\\lambda_1 L_{load}$ and $\\lambda_2 L_{metacog}$, we penalize responses that are either too complex or lack sufficient metacognitive scaffolding.
...
if response.status_code == 200:
    print("Article updated with formulas successfully!")
else:
